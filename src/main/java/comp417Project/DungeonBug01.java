...
public class DungeonBug01 extends Dungeon {

	public DungeonBug01(Pose _pose) {
		super("bug01", _pose, 10, 10, 4, Pose.fromXyz(8, 4, 3));
	...
	protected void generate(World world, int x, int y, int z) {
		...
		world.setBlock(x+2, y+0, z+4, Block.getBlockById(41));
		...
		world.setBlock(x+6, y+1, z+3, Block.getBlockById(7));
		...
		world.setBlock(x+6, y+1, z+4, Block.getBlockById(7));
		...
		world.setBlock(x+1, y+1, z+5, Block.getBlockById(7));
		...
		world.setBlock(x+1, y+1, z+6, Block.getBlockById(7));
		...
		world.setBlock(x+1, y+1, z+7, Block.getBlockById(7));
		...
		world.setBlock(x+1, y+1, z+8, Block.getBlockById(7));
		world.setBlock(x+2, y+1, z+8, Block.getBlockById(7));
		world.setBlock(x+3, y+1, z+8, Block.getBlockById(7));
		world.setBlock(x+4, y+1, z+8, Block.getBlockById(7));
		world.setBlock(x+5, y+1, z+8, Block.getBlockById(7));
		world.setBlock(x+6, y+1, z+8, Block.getBlockById(7));
		world.setBlock(x+7, y+1, z+8, Block.getBlockById(7));
		world.setBlock(x+8, y+1, z+8, Block.getBlockById(7));
		world.setBlock(x+9, y+1, z+8, Block.getBlockById(7));
		...
		world.setBlock(x+6, y+2, z+3, Block.getBlockById(7));
		...
		world.setBlock(x+6, y+2, z+4, Block.getBlockById(7));
		...
		world.setBlock(x+1, y+2, z+5, Block.getBlockById(7));
		...
		world.setBlock(x+1, y+2, z+6, Block.getBlockById(7));
		...
		world.setBlock(x+1, y+2, z+7, Block.getBlockById(7));
		...
		world.setBlock(x+1, y+2, z+8, Block.getBlockById(7));
		world.setBlock(x+2, y+2, z+8, Block.getBlockById(7));
		world.setBlock(x+3, y+2, z+8, Block.getBlockById(7));
		world.setBlock(x+4, y+2, z+8, Block.getBlockById(7));
		world.setBlock(x+5, y+2, z+8, Block.getBlockById(7));
		world.setBlock(x+6, y+2, z+8, Block.getBlockById(7));
		world.setBlock(x+7, y+2, z+8, Block.getBlockById(7));
		world.setBlock(x+8, y+2, z+8, Block.getBlockById(7));
		world.setBlock(x+9, y+2, z+8, Block.getBlockById(7));
